    ...
    <section className="section-padding bg-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center relative z-10">
        ...
        <motion.h3
          ...
          className="text-4xl lg:text-5xl font-heading font-black text-navy mb-20 leading-tight"
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {testimonials.map((testimonial, idx) => (
            <motion.div
              ...
              whileHover={{ y: -10 }}
              className="bg-cream p-12 rounded-20 text-left relative group border border-transparent hover:border-border/50 hover:bg-white hover:shadow-premium transition-all duration-500"
            >
              ...
              <p className="text-text italic mb-10 leading-relaxed font-medium">
                "{testimonial.content}"
              </p>
