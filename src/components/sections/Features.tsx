    ...
    <section className="py-24 bg-cream">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="mb-16 text-center">
          ...
          <div className="w-16 h-1.5 bg-accent mt-6 mx-auto" />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, idx) => (
            <motion.div
              ...
              className="bg-white p-10 rounded-2xl shadow-soft hover:shadow-premium transition-all duration-500 group border border-border hover:border-accent hover:-translate-y-2 cursor-pointer"
            >
