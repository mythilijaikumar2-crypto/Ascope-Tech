...
const TCSIcon: React.FC = () => (
  <svg className="h-8 w-auto shrink-0" viewBox="0 0 145 35" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M 12 7 L 12 25 C 12 29 17 29 19 27 M 6 12 L 18 12" stroke="url(#tcsGrad2)" strokeWidth="4.5" strokeLinecap="round" strokeLinejoin="round" fill="none" />
    <path d="M 37 14 C 34 11 26 11 26 18.5 C 26 26 34 26 37 23" stroke="url(#tcsGrad2)" strokeWidth="4.5" strokeLinecap="round" strokeLinejoin="round" fill="none" />
    <path d="M 52 13.5 C 50 11.5 45 10.5 45 14.5 C 45 18 53 17 53 22.5 C 53 26.5 47 26.5 44 24.5" stroke="url(#tcsGrad2)" strokeWidth="4.5" strokeLinecap="round" strokeLinejoin="round" fill="none" />
...
const LtiMindtreeIcon: React.FC = () => (
  <svg className="h-7 w-auto shrink-0" viewBox="0 0 170 36" fill="none" xmlns="http://www.w3.org/2000/svg">
    <defs>
      <linearGradient id="ltiGrad2" x1="0%" y1="0%" x2="0%" y2="100%">
        <stop offset="0%" stopColor="#e01b84" />
        <stop offset="100%" stopColor="#78248c" />
      </linearGradient>
    </defs>
    {/* Concentric Tree Circuit Emblem */}
    <circle cx="18" cy="18" r="14" stroke="url(#ltiGrad2)" strokeWidth="2" fill="none" />
    <g stroke="url(#ltiGrad2)" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" fill="none">
