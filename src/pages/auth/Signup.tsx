    ...
    <div className="min-h-screen pt-20 flex items-center justify-center bg-background p-6 overflow-hidden relative">
      ...
      >
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl font-heading font-bold text-primary mb-3">Create Account</h2>
          <p className="text-dark/40 text-sm font-bold uppercase tracking-widest">Start your tech journey today</p>
        </div>

        <form className="space-y-6">
          <div className="space-y-2">
            <label className="text-[10px] font-black text-dark/40 uppercase tracking-widest ml-1">Full Name</label>
            <div className="relative">
              ...
              <input 
                ...
                className="w-full pl-14 pr-6 py-4 rounded-[20px] bg-background border border-transparent focus:border-secondary focus:bg-white outline-none transition-all shadow-inner font-medium"
              />
            </div>
          </div>
          <div className="space-y-2">
            <label className="text-[10px] font-black text-dark/40 uppercase tracking-widest ml-1">Email Address</label>
            <div className="relative">
              <div className="absolute left-6 top-1/2 -translate-y-1/2 text-primary/30">
                <MailIcon />
              </div>
          ...
          <div className="space-y-2">
            <label className="text-[10px] font-black text-dark/40 uppercase tracking-widest ml-1">Password</label>
            <div className="relative">
              <div className="absolute left-6 top-1/2 -translate-y-1/2 text-primary/30">
                <LockIcon />
              </div>
          ...
          <div className="flex items-center gap-3 px-1 py-2">
             <input type="checkbox" className="w-5 h-5 rounded-lg accent-primary border-none bg-background shadow-inner cursor-pointer" />
             <label className="text-xs text-dark/40 font-bold">I agree to the <a href="#" className="text-secondary hover:underline">Terms of Service</a></label>
          </div>

          <GradientButton className="w-full py-5 text-xl shadow-layered mt-4">
            Create Account
          </GradientButton>
        </form>
